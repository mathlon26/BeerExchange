            ...
            <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    ...
                    <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                        ...
                        <nav class="-mx-3 flex flex-1 justify-end">
                            ...
                            <a href="{{ url('/dashboard') }}"
                                class="amaranth-regular rounded-md px-3 py-2 text-black hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20]">
                                Dashboard
                            </a>
                            @else
                            <a href="{{ route('login') }}"
                        ...
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            <a href="{{ route('entercode') }}" id="docs-card"
                                ...
                                <div id="screenshot-container" class="relative flex w-full flex-1 items-stretch">
                                    <img src="{{asset("/images/BerChart.png")}}" alt="event example picture"
                            ...
                            <div id="helpus-card"
                                class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10">
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="amaranth-regular text-xl font-semibold text-black">Support Me!</h2>
    
                                    <p class="mt-4 text-sm/relaxed">
                                        I do my best keeping this website up and running. However I am just a simple
                                        student with a passion for coding and beer 🍻 feel free to support me by clicking
                                        here: <a href="https://www.paypal.com/paypalme/mathijsfollon"
                                            class="rounded-sm underline hover:text-black focus:outline-none focus-visible:ring-[#FF2D20]">PayPal</a>,
                                        <a onclick="copyToClipBoard('38sxLn2GCUsmTFC1Mfor8Za6un7aepLAvL')"
                                            class="point-me rounded-sm underline hover:text-black focus:outline-none focus-visible:ring-[#FF2D20]">BTC
                                            address</a>,
                                        <a onclick="copyToClipBoard('0x5693cf8917b412f66c8ae841c4f5f813397a6812')"
                                            class="point-me rounded-sm underline hover:text-black focus:outline-none focus-visible:ring-[#FF2D20]">ETH
                                            address</a>
                                    </p>
                                </div>
                            </div>
                    ...
                    <footer class="py-16 text-center text-sm text-black">
                        ©2024-2025 by <a href="https://www.github.com/mathlon26" target="_blank">Mathijs Follon</a>.
                    </footer>
                </div>
            </div>
        </div>
