                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('drinks.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="logo" id="logo" class="form-input w-full" value="{{ old('logo') }}">
                        </div>

                        <div class="mb-4">
                            <label for="market_price" class="block text-gray-700">Market Price</label>
                            <input type="number" name="market_price" id="market_price" class="form-input w-full" value="{{ old('market_price') }}">
                        </div>
